...
function CheckoutRoute(){
 ...
 const qs=typeof window==='undefined'?new URLSearchParams():new URLSearchParams(window.location.search),embedded=qs.get('embedded')==='1',returnTo=qs.get('returnTo')||''
