...
function CheckoutRoute(){
 ...
 return <main className={`${embedded?"min-h-full":"min-h-[100svh]"} bg-[#050608] text-white`}>
  <div className={`mx-auto w-full ${embedded?"max-w-2xl px-4 pb-[max(1rem,env(safe-area-inset-bottom))] pt-3 sm:px-6 sm:py-6":"max-w-6xl px-4 py-6 sm:px-8 sm:py-10"}`}>
   ...
   <div className={embedded?"mx-auto max-w-xl pb-3 pt-0":"grid gap-7 py-7 lg:grid-cols-[minmax(0,1fr)_24rem] lg:gap-10 lg:py-12"}>
    <section>
