...
function Page() { return <CataloguePage mode="series" title="TV Shows" intro="Original series and episodic stories from Avant, built to be discovered chapter by chapter." />; }
