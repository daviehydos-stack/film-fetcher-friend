...
function SearchPage() {
  ...
  return <StreamingShell><main className="mx-auto min-h-[75vh] max-w-[1500px] px-5 pb-20 pt-28 sm:px-10 lg:px-14">
    ...
    <label className="relative mt-8 block max-w-2xl"><Search className="absolute left-4 top-3.5 size-5 text-muted-foreground"/><Input autoFocus value={query} onChange={(e)=>setQuery(e.target.value)} placeholder="Titles, genres, stories..." aria-label="Search Avant titles" type="search" className="h-12 bg-surface pl-12 text-base"/></label>
