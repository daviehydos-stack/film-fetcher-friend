  ...
  return (
    <main className="min-h-screen bg-[#07090D] text-white grid place-items-center px-6">
      <section className="max-w-md text-center">
        <LoaderCircle className="mx-auto size-9 animate-spin text-white/70" aria-hidden />
        <h1 className="mt-5 text-2xl font-semibold">Confirming your payment</h1>
        <p className="mt-3 text-sm leading-6 text-white/55">
          We are verifying the transaction securely. Access is activated only after the payment
          provider confirms it on the server.
        </p>
