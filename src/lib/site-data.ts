...
const AVANT_VIMEO_FALLBACKS: Record<string, Partial<CatalogueTitle> & { episodes?: Episode[] }> = {
  "a-better-life": {
    ...
    episodes: [
      ...
      { id:"abl-6", title:"Episode 6", season:1, episodeNumber:6, duration:"", vimeoVideoId:"1188396158", locked:true, legacyKey:"a-better-life-6" },
      { id:"abl-7", title:"Episode 7", season:1, episodeNumber:7, duration:"", vimeoVideoId:"1188398095", locked:true, legacyKey:"a-better-life-7" },
      { id:"abl-8", title:"Episode 8", season:1, episodeNumber:8, duration:"", vimeoVideoId:"1188399678", locked:true, legacyKey:"a-better-life-8" },
      { id:"abl-9", title:"Episode 9", season:1, episodeNumber:9, duration:"", vimeoVideoId:"1188401067", locked:true, legacyKey:"a-better-life-9" },
      { id:"abl-10", title:"Episode 10", season:1, episodeNumber:10, duration:"", vimeoVideoId:"1188402377", locked:true, legacyKey:"a-better-life-10" },
      { id:"abl-11", title:"Episode 11", season:1, episodeNumber:11, duration:"", vimeoVideoId:"1188403877", locked:true, legacyKey:"a-better-life-11" },
      { id:"abl-12", title:"Episode 12", season:1, episodeNumber:12, duration:"", vimeoVideoId:"1188405776", locked:true, legacyKey:"a-better-life-12" },
      { id:"abl-13", title:"Episode 13", season:1, episodeNumber:13, duration:"", vimeoVideoId:"1188408045", locked:true, legacyKey:"a-better-life-13" },
      { id:"abl-s2e1", title:"Episode 1", season:2, episodeNumber:1, duration:"", vimeoVideoId:"1188409403", locked:true, legacyKey:"a-better-life-s2e1" },
      { id:"abl-s2e2", title:"Episode 2", season:2, episodeNumber:2, duration:"", vimeoVideoId:"1188410987", locked:true, legacyKey:"a-better-life-s2e2" },
      { id:"abl-s2e3", title:"Episode 3", season:2, episodeNumber:3, duration:"", vimeoVideoId:"1188412824", locked:true, legacyKey:"a-better-life-s2e3" },
      { id:"abl-s2e4", title:"Episode 4", season:2, episodeNumber:4, duration:"", vimeoVideoId:"1188414524", locked:true, legacyKey:"a-better-life-s2e4" },
      { id:"abl-s2e5", title:"Episode 5", season:2, episodeNumber:5, duration:"", vimeoVideoId:"1188416096", locked:true, legacyKey:"a-better-life-s2e5" },
      { id:"abl-s2e6", title:"Episode 6", season:2, episodeNumber:6, duration:"", vimeoVideoId:"1188417664", locked:true, legacyKey:"a-better-life-s2e6" },
      { id:"abl-s2e7", title:"Episode 7", season:2, episodeNumber:7, duration:"", vimeoVideoId:"1188419269", locked:true, legacyKey:"a-better-life-s2e7" },
      { id:"abl-s2e8", title:"Episode 8", season:2, episodeNumber:8, duration:"", vimeoVideoId:"1188420871", locked:true, legacyKey:"a-better-life-s2e8" },
      { id:"abl-s2e9", title:"Episode 9", season:2, episodeNumber:9, duration:"", vimeoVideoId:"1188422333", locked:true, legacyKey:"a-better-life-s2e9" },
      { id:"abl-s2e10", title:"Episode 10", season:2, episodeNumber:10, duration:"", vimeoVideoId:"1188423921", locked:true, legacyKey:"a-better-life-s2e10" },
      { id:"abl-s2e11", title:"Episode 11", season:2, episodeNumber:11, duration:"", vimeoVideoId:"1188425468", locked:true, legacyKey:"a-better-life-s2e11" },
      { id:"abl-s2e12", title:"Episode 12", season:2, episodeNumber:12, duration:"", vimeoVideoId:"1188427046", locked:true, legacyKey:"a-better-life-s2e12" },
      { id:"abl-s2e13", title:"Episode 13", season:2, episodeNumber:13, duration:"", vimeoVideoId:"1188428575", locked:true, legacyKey:"a-better-life-s2e13" },
    ],
  },
