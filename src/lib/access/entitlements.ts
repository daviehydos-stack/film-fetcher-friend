...
export function entitlementGrantsContent(
  entitlement: Entitlement,
  target: { contentId: string; seasonId?: string },
  now = new Date(),
) {
  ...
  // Bundle/subscription expansion must be resolved server-side from product mappings.
  return false
}
