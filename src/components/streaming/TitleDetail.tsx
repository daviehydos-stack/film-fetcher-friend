...
export function TitleDetail({ item }: { item: CatalogueTitle }) {
  ...
  return (
    <StreamingShell>
      <main>
        <section className="relative min-h-[68svh] overflow-hidden sm:min-h-[72vh]">
          <img src={item.backdrop} alt="" className="absolute inset-0 size-full object-cover object-[62%_center] sm:object-center" />
