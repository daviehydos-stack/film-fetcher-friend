...
export function ContentRail({ title, items }: { title: string; items: CatalogueTitle[] }) {
  ...
  return (
    <section aria-label={title} className="py-5 sm:py-7">
      ...
      <div ref={rail} tabIndex={0} aria-label={`${title} titles`} className="hide-scrollbar flex snap-x snap-mandatory gap-3 overflow-x-auto scroll-smooth px-5 pb-5 sm:gap-4 sm:px-10 lg:px-14">
